    ...
    $.extend($.summernote.plugins, {
      'sDraftsSave': function(context) {
        ...
        context.memo('button.sDraftsSave', function() {
          var button;
          button = ui.button({
            contents: options.sDrafts.saveIcon && typeof options.sDrafts.saveIcon === 'string' ? options.sDrafts.saveIcon : lang.save,
            tooltip: lang.save,
            click: function(e) {
              e.preventDefault();
    ...
    return $.extend($.summernote.plugins, {
      'sDraftsLoad': function(context) {
        ...
        fn = function() {
          ...
          return htmlList += "<li class='list-group-item'><a href='#' class='note-draft' data-draft='" + key + "'>" + fName + " - <small>" + fDate + "</small></a><a href='#' class='label label-danger pull-right delete-draft' data-draft='" + key + "'>" + lang.deleteDraft + "</a></li>";
        };
        for (key in drafts) {
          draft = drafts[key];
          fn();
        ...
        context.memo('button.sDraftsLoad', function() {
          var button;
          button = ui.button({
            contents: options.sDrafts.loadIcon && typeof options.sDrafts.loadIcon === 'string' ? options.sDrafts.loadIcon : lang.load,
            tooltip: lang.load,
            click: function(e) {
              e.preventDefault();
